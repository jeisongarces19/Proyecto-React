                ...
                <div className="container-fluid">
                    ...
                    <div className={`navbar-menu ${this.state.mostrarMenu ? "is-active" : ""}`}>
                        <div className="navbar-start">
                            ...
                            <a onClick={this.ocultarMenu} activeclassname="is-active" className="navbar-item" href="/MenuUsuario">MENU 🕵</a>
                            <a onClick={this.ocultarMenu} activeclassname="is-active" className="navbar-item" href="/ListarExposicionesVirtuales">EXPOSICIONES DIGITALES 📌</a>
