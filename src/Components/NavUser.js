                ...
                <div className="container-fluid">
                    ...
                    <div className={`navbar-menu ${this.state.mostrarMenu ? "is-active" : ""}`}>
                        <div className="navbar-start">
                            ...
                            <a onClick={this.ocultarMenu} activeclassname="is-active" className="navbar-item" href="/MenuUsuario">MENÚ 🕵</a>
                            <a onClick={this.ocultarMenu} activeclassname="is-active" className="navbar-item" href="/ListarExposicionesVirtuales">VER EXPOSICIONES 📌</a>
                        ...
                        <div className="navbar-end">
                            <div className="navbar-item">
                                <div className="buttons">
                                    <a target="_blank" rel="noreferrer" href="https://youtu.be/0FdnBJcNfMk" className="button is-primary">
                                        <strong>?</strong>
                                    </a>
                                </div>
                            </div>
