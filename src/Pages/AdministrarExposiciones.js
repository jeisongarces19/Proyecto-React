...
class AdministrarExposiciones extends React.Component {
              ...
              <div className="column"></div>
                ...
                <div className="column is-two-thirds" >
                    ...
                    <center>
                        ...
                        <div className="form-group">                                
                            <input autoFocus required placeholder="ID:" type="number" id="id" className="FondoInput" onChange={this.manejarCambio} value={this.state.data.id} >
                            </input>
                        </div>
    ...
    async eliminarExposicion(evento){
        ...
        const detener = () =>{
            swal({
              title: "Error",
              text: "No existe exposicion o no es el propietario",
              icon: "error",
              timer: 6000,
            });
        }    
        ...
        var respuesta = await fetch(`https://proyecto-meca-cali.herokuapp.com/VirtualExpositions/Delete/`+id_ser3+`/`+parseInt(this.state.data.id), 
        {
            method: "DELETE",    
        });
