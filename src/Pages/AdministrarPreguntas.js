                ...
                <div className="column" >
                  ...
                  <div className="cardTabla">
                    <center>
                      ...
                      <h1 className="opcionesletra">ADMINISTRATIVAS PREGUNTAS!</h1>            
                      
                      <form className="">                         

                          
                          <div className="form-group">                                
                            <input autoFocus  placeholder="Id: Responder/Eliminar" type="number" id="id" className="FondoInput" onChange={this.manejarCambio} value={this.state.data.id} >
                            </input>
                          </div>
    ...
    async responderPregunta(evento){
        ...
        const continuar = () =>{
            swal({
              ...
              text: "se actualizo o respondio la pregunta",
              icon: "success",                        
            }).then(function() {
