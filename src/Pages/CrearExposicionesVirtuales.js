                ...
                <div className="column" >
                    ...
                    <center>
                        ...
                        <form className="" onSubmit={this.manejarEnvioDeFormulario}>
                            ...
                            <div className="form-group">
                                <textarea rows="3" placeholder="☕ Descripcion Personal" className="FondoInput" id="description"  onChange={this.manejarCambio} value={this.state.data.description}></textarea>
                            </div>  
