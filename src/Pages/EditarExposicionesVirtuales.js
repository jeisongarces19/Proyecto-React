...
class EditarExposicionesVirtuales extends React.Component {
    constructor(props) {
        ...
        this.SubirPhoto= this.SubirPhoto.bind(this);
                    ...
                    <div className="cardEditarExposicion">
                        <center>
                            ...
                            <form className="">      
                                ...
                                <h3>Subir Fotos</h3> 
                                <div className="form-group">   
                                    <button className="button is-primary mt-2"  onClick={this.SubirPhoto}>
                                       🔼
                                    </button>                                     
                                    <span> </span>                                              
                                    <div>
                                        <input autoFocus placeholder="Subir" type="file" id="subir" className="FondoInput">
                                        </input> 
                                    </div>                                    
                                </div>
    ...
    /*Aqui es donde se sube la informacion de las fotos*/
    async SubirPhoto(evento) {
        ...
        */
        const detener = () =>{
            swal({
              title: "Aviso",
              text: "¡Estamos trabajando en esto :( !. ¡Gracias! ",
              icon: "error",
              dangerMode: true,
            })
            .then(willDelete => {
              if (willDelete) {
                swal("¡Utilizar la otra forma!");
              }
            });
        }  
