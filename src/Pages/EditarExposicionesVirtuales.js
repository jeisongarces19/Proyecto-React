                        ...
                        <center>
                            ...
                            <form className="">
                                ...
                                <div>     
                                    ...
                                    <h3>Biografia 💬</h3>
                                    <div className="form-group">                                            
                                        <textarea rows="4" placeholder="Biografia " className="FondoInput" id="bibliography"  onChange={this.manejarCambiodata} value={this.state.data.bibliography}></textarea>
                                    </div>
                                    <span> </span>
