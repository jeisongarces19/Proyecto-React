...
const columns: Column[] = [
  ...
  { id: 'admin', label: 'Tipo'},
  { id: 'req_admin', label: 'Solicito'},
];

function ColumnGroupingTable(props){
  const rows=props.todo
  //console.log("llego",rows)
  //const rows = [{id: 'India', email: 1324171354, admin: 3287263}];
                ...
                <div className="column" >
                  ...
                  <div className="cardTabla">
                    <center>
                      ...
                      <h1 className="opcionesletra">¡ADMINISTRAR USUARIOS!</h1>            
                      
                      <form className="">                         

                          
                          <div className="form-group">                                
                            <input autoFocus required placeholder="Id: Modificar/Eliminar" type="number" id="id" className="FondoInput" onChange={this.manejarCambio} value={this.state.data.id} >
                            </input>
                          </div>
