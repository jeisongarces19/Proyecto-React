...
class Perfil extends React.Component {
                ...
                <div className="column" >
                    ...
                    <div className="cardPerfil">
                        ...
                        <form className="" onSubmit={this.manejarEnvioDeFormulario}>
                            ...
                            <div className="form-group">
                                <input placeholder="🅰️ Primer Aprellido" type="text" id="last_name_1" className="FondoInput"  onChange={this.manejarCambio} value={this.state.data.last_name_1} >
                                </input>
                            </div>
                            ...
                            <div className="form-group">
                                <input placeholder="📷 Foto (Url)" type="text" id="picture" className="FondoInput"  onChange={this.manejarCambio} value={this.state.data.picture} >
                                </input>
                            </div>
    ...
    async manejarEnvioDeFormulario(evento) {
         ...
         const continuar = () =>{
            swal({
              title: "ACTUALIZAR",
              text: "Tu usuario ha sido actualizado :) ¡Felicitaciones!",
              icon: "success",              
            }).then(function() {
