                ...
                <div className="columnMiaP" >
                  ...
                  <div className="cardPregunta">
                    <center>
                      ...
                      <h1 className="preguntaletra">¿Cuál es tu pregunta?🧐</h1>                
                        ...
                        <form onSubmit={this.manejarEnvioDeFormulario}>
                            ...
                            <div className="form-group">                                    
                                <input autoFocus placeholder="General" type="text" id="name" className="FondoInput"  onChange={this.manejarCambio} value={this.state.data.name} >
                                </input> 
                            </div>
                            <span> </span>
                            <br></br>
                            ...
                            <h3>Detallar📝</h3>
                            <div className="form-group">                                    
                                <textarea rows="4" autoFocus placeholder="Especificar Pregunta " type="text" id="description" className="FondoInput"  onChange={this.manejarCambio} value={this.state.data.description} >
                                </textarea> 
                            </div>
                            <span> </span>
