                ...
                <div className="column" >
                    ...
                    <div className="card2">
                        ...
                        <form className="" onSubmit={this.manejarEnvioDeFormulario}>
                            ...
                            <div className="form-group">
                                <input autoFocus placeholder="🅰️ Primer Aprellido" type="text" id="last_name_1" className="FondoInput"  onChange={this.manejarCambio} value={this.state.data.last_name_1} >
                                </input>
                            </div>
                            ...
                            <div className="form-group">
                                <input autoFocus required placeholder="🔑 Contraseña ✔" type="password" id="password_hash" className="FondoInput"  onChange={this.manejarCambio} value={this.state.data.password_hash}>
                                </input> 
                            </div>
